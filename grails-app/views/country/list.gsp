			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="ccode" title="${message(code: 'country.ccode.label', default: 'Ccode')}" />
				...
				<g:each in="${countryInstanceList}" status="i" var="countryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${countryInstance.id}">${fieldValue(bean: countryInstance, field: "ccode")}</g:link></td>
