	...
	<body>
		...
		<div id="show-country" class="content scaffold-show" role="main">
			...
			<ol class="property-list country">
				...
				<g:if test="${countryInstance?.ccode}">
				<li class="fieldcontain">
					<span id="ccode-label" class="property-label"><g:message code="country.ccode.label" default="Ccode" /></span>
					
						<span class="property-value" aria-labelledby="ccode-label"><g:fieldValue bean="${countryInstance}" field="ccode"/></span>
