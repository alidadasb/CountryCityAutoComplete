	...
	<body>
		...
		<div id="show-city" class="content scaffold-show" role="main">
			...
			<ol class="property-list city">
				...
				<g:if test="${cityInstance?.ccode}">
				<li class="fieldcontain">
					<span id="ccode-label" class="property-label"><g:message code="city.ccode.label" default="Ccode" /></span>
					
						<span class="property-value" aria-labelledby="ccode-label"><g:fieldValue bean="${cityInstance}" field="ccode"/></span>
