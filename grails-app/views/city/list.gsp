			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="ccode" title="${message(code: 'city.ccode.label', default: 'Ccode')}" />
				...
				<g:each in="${cityInstanceList}" status="i" var="cityInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${cityInstance.id}">${fieldValue(bean: cityInstance, field: "ccode")}</g:link></td>
